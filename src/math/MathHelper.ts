...
export class MathHelper
{
    ...
    // 下面四个函数是平面相关函数
    //ax+by+cz-d=0
    public static planeFromPoints ( a: Vector3, b: Vector3, c: Vector3, result: Vector4 | null = null ): Vector4
    {
    ...
    public static convertVec3IDCoord2GLCoord ( v: Vector3, scale: number = 10.0 ): void
    {
    ...
    public static convertVec2IDCoord2GLCoord ( v: Vector2 ): void
    {
        v.y = 1.0 - v.y;
    }
